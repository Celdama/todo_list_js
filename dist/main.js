...
const UI = (() => {
  const loadCurrentDayTodoList = () => {
    ...
    const formatDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(new Date(), 'ccc dd MMM');
  ...
  const loadCurrentMonthTodoList = () => {
    const currentDate = document.querySelector('.current-date');
    const formatMonth = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(new Date(), 'MMMM');
