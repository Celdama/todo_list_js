...
const UI = (() => {
  const loadTodoList = (name = 'inbox') => {
    ...
    const currenDayTodoList = _handleTodo__WEBPACK_IMPORTED_MODULE_2__.handleTodoListModule.getTodoOfCurrentDay();
...
const todoFactory2 = (todo) => {
  const formatDueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(todo.dueDate), 'dd/MM/yyy');
  // console.log(test);
