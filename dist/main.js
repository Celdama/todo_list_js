...
const UI = (() => {
  ...
  const displayAddProjectForm = (hiddeFormOnSubmit) => {
    ...
    _utilities_handleEventListener__WEBPACK_IMPORTED_MODULE_0__["default"].listenerOnProjectFormBtn(
  ...
  const renderCompleteTodoItem = (todo) => {
    ...
    const completeTodoTitle = (0,_utilities_domElementFactory__WEBPACK_IMPORTED_MODULE_1__["default"])('span', `${todo.title}`, '');
    const completeTodoDescDiv = (0,_utilities_domElementFactory__WEBPACK_IMPORTED_MODULE_1__["default"])(
      'div',
      'Description: ',
      'complete-todo-desc'
    );
    const completeTodoDesc = (0,_utilities_domElementFactory__WEBPACK_IMPORTED_MODULE_1__["default"])(
      'span',
      `${todo.description}`,
      ''
    );
    ...
    const completeTodoPriority = (0,_utilities_domElementFactory__WEBPACK_IMPORTED_MODULE_1__["default"])(
      'span',
      `${todo.priority}`,
      ''
    );
    ...
    const completeTodoProject = (0,_utilities_domElementFactory__WEBPACK_IMPORTED_MODULE_1__["default"])(
      'span',
      `${todo.project}`,
      ''
    );
  ...
  const renderTodoItem = (todo) => {
    ...
    const displayTodoTitle = (0,_utilities_domElementFactory__WEBPACK_IMPORTED_MODULE_1__["default"])(
      'div',
      `${todo.title}`,
      'todo-title'
    );
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (handleEventListener);
