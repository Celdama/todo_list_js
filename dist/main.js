...
const UI = (() => {
  ...
  const fillPlaceHolderFormEditWithTodoData = (data) => {
    ...
    inputEditTodo.forEach((input) => {
      ...
      if (type === 'date') {
        const { dueDate } = data;
        const month = (0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(new Date(`${dueDate}`));
        const day = (0,date_fns__WEBPACK_IMPORTED_MODULE_9__["default"])(new Date(`${dueDate}`)) + 1;
        const year = (0,date_fns__WEBPACK_IMPORTED_MODULE_10__["default"])(new Date(`${dueDate}`));
