...
const UI = (() => {
  ...
  const fillPlaceHolderFormEditWithTodoData = (data) => {
    ...
    inputEditTodo.forEach((input) => {
      ...
      if (input.type === 'date') {
        const month = (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(new Date(`${data.dueDate}`)) + 1;
        const day = (0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(new Date(`${data.dueDate}`));
